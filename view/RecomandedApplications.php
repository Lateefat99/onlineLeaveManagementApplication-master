        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
					...
					?>
				<li>
                    <a style="color:#DAA520;" href="RecomandedApplications.php">Pre-Approved Applications<span style="color:red"><?php if($row['COUNT(lIsRecomanded)'] != 0){ ?> [ New <?php echo $row['COUNT(lIsRecomanded)']; ?> ]<?php } ?></span></a>
                </li>
					<?php
					}
					?>
