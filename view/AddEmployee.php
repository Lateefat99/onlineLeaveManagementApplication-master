        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
					...
					?>
				<li>
                    <a href="RecomandedApplications.php">Pre-Approved Applications<span style="color:red"><?php if($row['COUNT(lIsRecomanded)'] != 0){ ?> [ New <?php echo $row['COUNT(lIsRecomanded)']; ?> ]<?php } ?></span></a>
                </li>
					<?php
					}
					?>
                    ...
                    <div class="col-lg-12">
						...
						<form role="form" action="../controller/AddEmployeeController.php" method="post" >
							...
							<!--<div class="form-group">
								...
								<label for="empLoginPass">Employee Location: </label>
								<input type="text" class="form-control" placeholder="Employee Location ...." name="empLoginPass" id="empLoginPass" >
