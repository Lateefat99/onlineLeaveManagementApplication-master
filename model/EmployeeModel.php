...
<?php
	...
	class Employee extends DbOperation
	{
		...
		function dbCreateEmpQuery($empCodeName,$empFirstName,$empLastName,$empDoB,$empBloodGroup,$empGender,$empPhoneNumPersonal,$empPhoneNumOffice,$empParmanentAddress,$empPresentAddress,$empDptId,$empDesiId,$empEmailAddress,$empLoginPass,$hospitalLocation,$userCodeWhoCreateEmp,$empVerification,$empType)
		{
			$objDbOperation = new DbOperation();
			$this->check=0;
			
			$columnsName = "`eEmployeeCodeNumber`,`eFirstName`,`eLastName`,`eDateOfBirth`,`eBloodGroup`,`eGender`,`ePhoneNumberPersonal`,`ePhoneNumberOffice`,`eParmanentAddress`,`ePresentAddress`,`eDptId`,`eDesignationId`,`eEmailAddress`,`ePassword`,`eHospitalLocation`,`eEmployeeCodeNumberWhoAddEmployee`,`eEmployeeVerification`,`eEmpType`";
			//database column name
			$tablesName = "`employeeinfo`";
			//database table name
			$conditions = "'".$empCodeName."','".$empFirstName."','".$empLastName."','".$empDoB."','".$empBloodGroup."','".$empGender."','".$empPhoneNumPersonal."','".$empPhoneNumOffice."','".$empParmanentAddress."','".$empPresentAddress."','".$empDptId."','".$empDesiId."','".$empEmailAddress."','".$empLoginPass."','".$hospitalLocation."','".$userCodeWhoCreateEmp."','".$empVerification."','".$empType."'";
