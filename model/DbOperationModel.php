...
<?php
	...
	class DbOperation
	{
		...
		function forLeaveToDate(){
		    $objDbOperation = new DbOperation();
		    $this->check = 0;

		    $columnsName = "lLeaveToDate";
            $tablesName = "employeeleaveapplicationdetails";
            $conditions = "WHERE lEmployeeCodeNumberWhoApply = '".$_SESSION['officeUserName']."' AND lIsApproved = 1 ORDER BY lId DESC LIMIT 1";
